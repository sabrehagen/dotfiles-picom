...
uniform float sc_intensity = 0.2; // Intensity of the scanline effect
...
uniform float curvature = 1.0; // How much the window should "curve"
...
float flash_intensity = 0.5; // Intensity of flashing effect
