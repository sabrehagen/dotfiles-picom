...
uniform float cutoff = 0.35; // Brightness value that should be considered
                            // as a "bright" pixel

uniform float light_brightness = 3; // Scaling value for the brightness of the
                                    // bloom effect
...
uniform float kernel1[][] = { { 0.003, 0.013, 0.022, 0.013, 0.003 },
...
float blur_kernel[][] = kernel2; // Kernel to use for the gaussian blur
